    ...
    return (
        ...
        <div id="slide1" className="carousel-item relative w-full  ">
          ...
          <div className="absolute h-full flex rounded-xl  items-center left-0   top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0) ]">
             <div className='space-y-7 w-1/3 text-white pl-12 '>
               <h2 className='text-6xl text-white'>Affordable   Price For Car   Servicing</h2>
               <p>There are many variations of passages of  available, but    the majority have suffered alteration in some form</p>
               <div className='flex'>
               <button className="btn btn-danger mr-4">Discover Now</button>
               <button className="btn btn-outline text-white btn-light ">Latest Projects</button>
